...
const Header = () => {
  ...
  useEffect(() => {
    // Add event listeners for both dropdown and search bar
          ...
          >
           ...
           py-3 relative"
            >
              <div className="">
                <a href="/">
                  <img src={logo} alt="Patranee Logo" className="w-18 h-18" />
                </a>
              </div>
              ...
              max-lg:before:fixed max-lg:overflow-auto max-lg:before:bg-black max-lg:before:opacity-40
                ...
                <div className=" w-full">
                  ...
                  <div
                    ...
                    className={`absolute lg:right-13 lg:bottom-6 md:right-19 right-0
                      top-full md:w-[30rem] sm:w-[24rem] w-[21rem] px-3 py-2
                    ...
                    >
                      ...
                      <div
                        ...
                        className={`bg-white z-20 shadow-md py-6 px-6 sm:min-w-[320px] max-sm:min-w-[250px] 
                         absolute lg:right-0 right-0 top-14 opacity-0 transform
...
export default Header;
{
  /* <details
                       ...
                       h-10 open:h-fit overflow-hidden w- 56"
                        >
                          <summary
                            className="transition-all duration-500
                         flex cursor-pointer items-center rounded-lg
                          px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                          ...
                          <nav className="mt-1.5  flex flex-col transition-all duration-500">
                            <a
                              href=""
