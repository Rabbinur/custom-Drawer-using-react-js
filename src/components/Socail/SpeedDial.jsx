...
const SpeedDial = () => {
  ...
  return (
    <div
      ref={speedDialRef}
      className="fixed bottom-16 left-14 lg:left-16 z-[999]"
    >
      <div className="relative w-full h-full">
        ...
        >
          ...
          <button
            type="button"
            className="flex justify-center items-center w-16 h-16 text-white bg-green-500 
          ...
          <a
            ...
            type="button"
            className="flex justify-center items-center w-16 h-16 text-white bg-blue-500 rounded-full
        ...
        <button
          ...
          className="flex items-center justify-center text-white bg-indigo-600
           rounded-full w-16 h-16 hover:bg-indigo-700 focus:ring-4 focus:outline-none"
        >
          <TypeIcon type={"customer"} size={30} />
