...
const ProductListView = ({ item, discountPercentage, discountedPrice }) => {
  ...
  return (
    <div>
      <div className="flex gap-6 overflow-hidden border rounded  hover:-translate-y-2 transition-all cursor-pointer">
        <div className=" relative  bg-gray-100 p-3 overflow-hidden aspect-w-16 aspect-h-8 rounded-lg">
          <Link
            to={
          ...
          >
            <img
              className="h-60 w-96 object- top rounded-t-lg object-cover"
              src={item?.url[0]?.url}
              alt={item?.title}
              loading="lazy"
            />
