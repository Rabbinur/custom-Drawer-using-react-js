    ...
    <div className="container mx-auto py-20">
      {/* <div className="bg-white shadow-lg dark:bg-gray-900 p-11 ">
        ...
        <form onSubmit={handleSubmit}>
          <div className="relative flex flex-wrap my-5">
            <input
              type="email"
      ...
      <main className="w-full  max-w-md mx-auto p-6">
        <div>
          <h2 className="text-center text-xl">Welcome To Planter box</h2>
        </div>
                ...
                <div className="grid gap-y-4">
                  <div>
                    <label className="block">
                      ...
                      />
                     {provide&& <p className="mt-2  peer-invalid:visible animate-pulse text-pink-600 text-sm">
                        Please provide a valid email address.
                      </p>}
                      {show&&<p className="mt-2 animate-bounce peer-invalid:visible text-green-700 text-sm">
